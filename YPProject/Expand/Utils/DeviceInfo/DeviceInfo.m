...
+ (NSString *)getDeviceSize {
    ...
    NSString *devSize = [NSString stringWithFormat:@"%@",NSStringFromCGSize(size)];
    return devSize;
}
...
+ (NSString *)getDeviceScale {
    ...
    NSString *devScale = [NSString stringWithFormat:@"%.0fx%.0f",size.width * scale, size.height * scale];
    return devScale;
}
